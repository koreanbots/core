	...
	return (
		...
		>
			...
			<ul className='list-inside list-disc'>
				...
				<li>서버로 초대할 수 있는 공개 봇 (특수목적의 봇은 제외)</li>
				<li>
					...
					<ul className='pl-3 list-inside list-disc'>
						<li>
							...
							있다면, 소스 같은 곳뿐만 아니라 반드시 봇 설명에 기재해주세요.
						</li>
						<li>

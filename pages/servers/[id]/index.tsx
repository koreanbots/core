									...
									data.state === 'unreachable' ? <Message type='error'>
										...
										data.state === 'reported' ?
											<Message type='error'>
												...
												<p>해당 서버를 주의해주세요.</p>
												<p>서버 관리자 분은 <Link href='/guidelines' className='text-blue-500 hover:text-blue-400'>가이드라인</Link>에 대한 위반사항을 확인해주시고 <Link href='/discord' className='text-blue-500 hover:text-blue-400'>디스코드 서버</Link>로 문의해주세요.</p>
											</Message> : ''
								}
							</div>
